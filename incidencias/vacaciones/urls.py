...
urlpatterns = [
    ...
    path('list_crear_vacaciones', views.list_crear_vacaciones, name='list_crear_vacaciones'),
    path('list_edit_vacaciones/<int:id>/', views.list_edit_vacaciones, name='list_edit_vacaciones'),
